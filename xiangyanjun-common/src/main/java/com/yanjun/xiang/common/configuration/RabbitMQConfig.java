...
//    public static final String EXCHANGE_TOPIC_SAY_HELLO = "exchange.topic.say.hello";
//    public static final String QUEUE_TOPIC_SAY_HELLO = "queue.topic.say.hello";
...
*/
    ...
    */
    ...
    //direct交换机需要和队列绑定routingKey  fanout不需要绑定
    @Bean("businessBinding")
    public Binding businessBinding(@Qualifier("businessExchange") DirectExchange businessExchange,
                                   @Qualifier("businessQueue") Queue businessQueue){
        return BindingBuilder.bind(businessQueue).to(businessExchange).with("key");
    }
